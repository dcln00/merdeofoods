		...
		table(class="min-w-full table-fixed")
			thead
				tr(class="bg-gray-200 *:font-medium")
					th(class="w-3/12 px-4 py-3 text-left") Name
					th(class="w-2/12 px-4 py-3 text-left") Email
					th(class="w-2/12 px-4 py-3 text-left") Branch
					th(class="w-1/12 px-4 py-3 text-left") Role
